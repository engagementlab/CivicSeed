...
var PLAYER_SPRITE_HEIGHT = $game.TILE_SIZE * 2  // Height of one sprite
var PLAYER_SPRITESHEET_WIDTH = 128    // Width of full spritesheet for player skin
var PLAYER_SPRITESHEET_HEIGHT = 320   // Height of full spritesheet for player skin
var SPRITE_HEAD_HEIGHT = 30           // Height of sprite head part
var SPRITE_TORSO_HEIGHT = 15          // Height of sprite torso part
var SPRITE_LEGS_HEIGHT = 19           // Height of sprite legs part

var _tilesheets = {}
var _tilesheetWidth = 0
var _tilesheetHeight = 0

var _tilesheetCanvas = []
var _tilesheetContext = []

var _offscreenBackgroundContext = null

var _offscreenSkinSuitCanvas = {}
var _offscreenSkinSuitContext = {}

var _offscreenPlayersCanvas = {}
var _offscreenPlayersContext = {}

var _backgroundContext = null
var _foregroundContext = null
var _charactersContext = null
var _interfaceContext = null
var _minimapTileContext = null
...
var $render = $game.$render = module.exports = {
  ...
  makeQueue: function (callback) {
    ...
    var order = [playerInfo]
    var order2 = $game.$others.getRenderInfo()
    var order3 = $game.$npc.getRenderInfo()
    var botanistInfo = $game.$botanist.getRenderInfo()
    var robotInfo = $game.$robot.getRenderInfo()
  ...
  renderTile: function (i, j) {
    ...
    var backIndex2 = curTile.background2 - 1
    var backIndex3 = curTile.background3 - 1
    var foreIndex = curTile.foreground - 1
    var foreIndex2 = curTile.foreground2 - 1
    var colored = curTile.colored
    var tileData = {
      b1: backIndex1,
      b2: backIndex2,
      b3: backIndex3,
  ...
  createCanvasForPlayer: function (id, skinSuit, playerColor) {
    ...
    var headSpriteSource = _offscreenSkinSuitCanvas[skinSuit.head]
    var torsoSpriteSource = _offscreenSkinSuitCanvas[skinSuit.torso]
    var legsSpriteSource = _offscreenSkinSuitCanvas[skinSuit.legs]
  ...
  renderMouse: function (mouse) {
    ...
    var foreIndex2 = tile.foreground2 - 1
    var colored = tile.colored
    var foreData = {
      f1: foreIndex,
      f2: foreIndex2,
      destX: _prevMouseX,
