module.exports.global = [{
	...
	resource: {
		tagline: 'Host Communities: What They Give Us',
	...
	dialog: {
		smalltalk: ['replace'],
		prompts: ['Like the magician\'s circle always says, "THE SHOW MUST GO ON!" You must go on and talk to the others.', 'Wanna see a magic trick? BEHOLD! I WILL PULL A RABBIT OUT OF MY FACE...err..that doesn\'t sound right...', 'How will I ever put on my magicshow if no one will be able to see all the pretty colors?']
	}
}, {
	id: '9170',
	name: 'Blooper',
	...
	isHolding: false,
	dialog: {
		prompts: ['You humans crack me up. You all look the same! Calopi is filled with diversity. Zork and Framptonare so different, but they care about their home equally. Do you care about our community? Here is a question for you!', 'You have to do better than that!', 'Thanks for working with us. We gotta catch that darn robot! Without you it would be hard to organize all of these resources.']
	}
}, {
	id: '5063',
	name: 'Zork',
	...
	isHolding: true,
	dialog: {
		prompts: ['You\'re the one organizing the resrouces right? I seen types like you before. Coming in and trying to help our community without knowing anything about us. Maybe if you prove you aren\'t just here for glory and fame, and that you do want to help make Calipi a colorful world again, I will give you something that can help.', 'Try again, kid. ', 'My intial judgements about you might have been wrong. Still, I am keeping my eye on you! Don\'t try anything funny!']
	},
	resource: {
