module.exports.global = {
	...
	dialog: [{
		...
		riddle: {
			...
			responses: 'That’s right! Great work! Now you’re ready to move to level 2. I’ve given you some Mega Seeds that cover more area. Now, when you enter seed-planting mode, you will have the ability to plant a Mega or normal seed.'
		},
		...
		riddle: {
			...
			responses: 'Great work! Now you’re ready to move to level 3. Your Mega Seeds are now even more powerful!'
		},
		...
		riddle: {
			...
			prompts: ['Here, take a look at the next part of the enigma', 'It looks like you have enough pieces to solve the enigma, ready to try?'],
			responses: 'Great work! Now you’re ready to move to level 4. Your Mega Seeds have become more powerful than ever.'
		},
		hint: ['get more things', 'try harder']
	}, {
		instructions: ['To answer the fourth section of the enigma, journey to the Port District, located in the southwest section of the world.'],
		riddle: {
			...
			prompts: ['Here, take a look at the next part of the enigma', 'It looks like you have enough pieces to solve the enigma, ready to try?'],
			responses: 'You did it! You solved the final piece of the enigma!'
		},
		hint: ['get more things', 'try harder']
	}, {
