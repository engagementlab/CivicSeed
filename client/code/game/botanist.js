		...
		if(_promptNum === 0) {
			if(_currentSlide === 0) {
				...
				if($game.$player.currentLevel === 0) {
					...
					$botanistContent.html('<p><img class="miniExample" src="/img/game/minimap.png"></p><p>Go out and talk to the people you see. When you think you have all the pieces, come back to the center of the map and talk to me. Good luck!</p>');
				}
			}
		}
